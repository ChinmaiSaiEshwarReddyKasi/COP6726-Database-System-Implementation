...
const char *dbfile_dir = "db/"; // dir where binary heap files should be stored
const char *tpch_dir ="tpch/10M/"; // dir where dbgen tpch files (extension *.tbl) can be found
